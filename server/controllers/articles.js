...
export const createArticle = async (req,res)=>{
    ...
    const newArticle = new postArticle({...article,author:req.userId,createdAt:new Date().toISOString()})
    try{
...
export const updateArticle = async(req,res)=>{
    ...
    if(!mongoose.Types.ObjectId.isValid(_id)){
        ...
        const updatedArticle = await postArticle.findByIdAndUpdate(_id,article,{new:true});
